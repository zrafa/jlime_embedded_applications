...
libdir = $(LIBDIR)
AR = ar
CC = mipsel-linux-uclibc-gcc -mips32
CXX = mipsel-linux-uclibc-gcc -mips32
HOST_CC = gcc
RANLIB = true
LDCONFIG = ldconfig
INSTALL = install
EXTRA_INC = -I/mnt/sda6/programas/stuff/extra-packages/sources/MPlayer-1.0rc2-kai_test2/madlib/v2/libmad-0.15.1b  
EXTRAXX_INC = -I/mnt/sda6/programas/stuff/extra-packages/sources/MPlayer-1.0rc2-kai_test2/madlib/v2/libmad-0.15.1b   -I/mnt/sda6/programas/stuff/extra-packages/sources/MPlayer-1.0rc2-kai_test2/madlib/v2/libmad-0.15.1b/liveMedia/include                   -I/mnt/sda6/programas/stuff/extra-packages/sources/MPlayer-1.0rc2-kai_test2/madlib/v2/libmad-0.15.1b/UsageEnvironment/include                   -I/mnt/sda6/programas/stuff/extra-packages/sources/MPlayer-1.0rc2-kai_test2/madlib/v2/libmad-0.15.1b/BasicUsageEnvironment/include                   -I/mnt/sda6/programas/stuff/extra-packages/sources/MPlayer-1.0rc2-kai_test2/madlib/v2/libmad-0.15.1b/groupsock/include
OPTFLAGS = -I. -I.. -I../libavutil -O3 -D_REENTRANT -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -DHAVE_CONFIG_H $(EXTRA_INC)
CXXFLAGS =  -I. -I.. -I../libavutil -O3 -D_REENTRANT -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -DHAVE_CONFIG_H -D__STDC_LIMIT_MACROS $(EXTRAXX_INC)
CFLAG_STACKREALIGN = 
INSTALLSTRIP = -s
CHARSET = 
...
EXTRALIBS = 
EXTRA_LIB = /mnt/sda6/programas/stuff/extra-packages/sources/MPlayer-1.0rc2-kai_test2/madlib/v2/libmad-0.15.1b/liveMedia/libliveMedia.a                  /mnt/sda6/programas/stuff/extra-packages/sources/MPlayer-1.0rc2-kai_test2/madlib/v2/libmad-0.15.1b/groupsock/libgroupsock.a                  /mnt/sda6/programas/stuff/extra-packages/sources/MPlayer-1.0rc2-kai_test2/madlib/v2/libmad-0.15.1b/UsageEnvironment/libUsageEnvironment.a                  /mnt/sda6/programas/stuff/extra-packages/sources/MPlayer-1.0rc2-kai_test2/madlib/v2/libmad-0.15.1b/BasicUsageEnvironment/libBasicUsageEnvironment.a                  -L/mnt/sda6/programas/stuff/extra-packages/sources/MPlayer-1.0rc2-kai_test2/madlib/v2/libmad-0.15.1b/.libs  -liconv -lncurses -lpng -lz -ljpeg -lungif -lcdda_interface -lcdda_paranoia -lenca -lz -lmad -lspeex -ltheora -logg -lmpcdec  -lstdc++ -lpthread -ldl -rdynamic  -lm
EXTRALIBS_MPLAYER =  -laa -ljack -lfaac
...
# --- libvo stuff ---
VO_SRCS =  vo_tga.c vo_md5sum.c x11_common.c vo_x11.c vo_xover.c vo_aa.c vo_fbdev.c vo_fbdev2.c vo_png.c vo_jpeg.c vo_pnm.c vo_gif89a.c vo_v4l2.c

# --- libao2 stuff ---
AO_SRCS =  ao_v4l2.c ao_oss.c ao_jack.c
